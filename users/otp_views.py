...
class getPhoneNumberRegistered(APIView):
    ...
    def get(request, phone):
        try:
            Mobile = CustomeUser.objects.get(mobile_number=phone)  # if Mobile already exists the take this else create New One
        except ObjectDoesNotExist:
            CustomeUser.objects.create(
                Mobile=phone,
            )
            Mobile = CustomeUser.objects.get(mobile_number=phone)  # user Newly created Model
    ...
    def post(request, phone):
        try:
            Mobile = CustomeUser.objects.get(mobile_number=phone)
        except ObjectDoesNotExist:
...
class getPhoneNumberRegistered_TimeBased_verify(APIView):
    # Get to Create a call for OTP
    # This Method verifies the OTP
